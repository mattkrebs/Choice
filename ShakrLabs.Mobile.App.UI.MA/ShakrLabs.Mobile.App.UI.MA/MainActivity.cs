...
namespace ShakrLabs.Mobile.App.UI.MA
{
    ...
    public class MainActivity : Activity
    {
        ...
        const String APP_ID = "226855460778202";
        private LoginButton mLoginButton;
        private TextView mText;
        private Button btnChoosin;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            try
            {
                info = PackageManager.GetPackageInfo("ShakrLabs.Mobile.App.UI.MA", PackageInfoFlags.Signatures);
                foreach (var signature in info.Signatures)
                {
                    ...
                    System.Console.WriteLine("hash key {0}", something);
                }

            }
            catch (Exception e1)
            {
                System.Console.WriteLine("name not found {0}", e1.InnerException);
            }
        ...
        {
            public SampleAuthListener(MainActivity parent)
            {
                this.parent = parent;
            }
            MainActivity parent;
            ...
            public void OnAuthFail(String error)
            {
                ...
                Toast.MakeText(parent, String.Format("Login Failed {0}", error), ToastLength.Long);
            }
        }

        public class SampleLogoutListener : SessionEvents.ILogoutListener
        {
            public SampleLogoutListener(MainActivity parent)
            {
                this.parent = parent;
            }
            MainActivity parent;
        ...
        {
            public SampleRequestListener(MainActivity parent)
            {
                this.parent = parent;
            }
            MainActivity parent;
            ...
            public override void OnComplete(String response, Object state)
            {
                try
                {
                    ...
                    System.Console.WriteLine("Facebook Response :" + json.ToString());
        ...
        {
            public SampleUploadListener(MainActivity parent)
            {
                this.parent = parent;
            }
            MainActivity parent;
        ...
        {
            public WallPostRequestListener(MainActivity parent)
            {
                this.parent = parent;
            }
            MainActivity parent;
        ...
        {
            public WallPostDeleteListener(MainActivity parent)
            {
                this.parent = parent;
            }
            MainActivity parent;
        ...
        {
            public SampleDialogListener(MainActivity parent)
            {
                this.parent = parent;
            }
            MainActivity parent;
